...
namespace Jg.wpf.controls.Customer.FastDataGrid.Controls
{
    partial class FastGridControl
    {
        ...
        {
            return new IntRect(new IntPoint(HeaderWidth, HeaderHeight), new IntSize(_columnSizes.FrozenSize, GridScrollAreaHeight));
        }

        private IntRect GetFrozenRowsRect()
        {
            return new IntRect(new IntPoint(HeaderWidth, HeaderHeight), new IntSize(GridScrollAreaHeight, _rowSizes.FrozenSize));
        }
        ...
        private IntRect GetGridHeaderRect()
        {
            ...
            return new IntRect(new IntPoint(0, 0), new IntSize(0, 0));
        }
        ...
        private void FixScrollPosition()
        {
            ...
            AdjustScrollBarPositions();
            OnChangeSelectedCells(false, _currentCell.Row, _currentCell.Column);
        }
